...
void build_space() {
    ...
    trigs[3] = {{2, 0, 1}, {2.5, sqrt(3)/6., sqrt(2./3.) + 1}, {2.5, sqrt(3)/2., 1}, {255, 0, 0, 0}};
    trigs[4] = {{3, 0, 1}, {2.5, sqrt(3)/6., sqrt(2./3.) + 1}, {2, 0, 1}, {255, 0, 0, 0}};
    trigs[5] = {{2.5, sqrt(3)/2., 1}, {2.5, sqrt(3)/6., sqrt(2./3.) + 1}, {3, 0, 1}, {255, 0, 0, 0}};
